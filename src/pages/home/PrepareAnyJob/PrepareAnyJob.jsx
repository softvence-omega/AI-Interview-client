  ...
  return (
    ...
    >
      <div className="content-wrapper">
        ...
        />
        <h1 className="text-white w-[70%] mx-auto">
          Instantly Prepare for Any Job with Our Chrome Extension
        </h1>
        <p className="w-[80%] mx-auto text-[#676768] mt-4">
          Found the perfect job? With the inprep.ai Chrome Extension, instantly
          generate tailored mock interviews directly from any job posting. Scan
          the generated QR code using the inprep.ai mobile app and practice for
          the exact interview scenario, powered by AI.
        </p>
