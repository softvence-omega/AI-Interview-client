...
const WhyChoose = () => {
  return (
    <div className="mt-24">
      ...
      <p className="text-center text-[16px] font-normal leading-[24px] tracking-[-0.32px] text-[#676768] px-2 lg:w-[580px] mx-auto">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-20 p-2 md:p-2 lg:p-0">
        {interviewData.map((item, index) => (
          <div key={index} className="w-full sm:w-1/2 md:w-full bg-white rounded-xl shadow-md border border-[#37B874]">
